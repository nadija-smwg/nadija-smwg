...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:312e81,50:6366f1,100:8b5cf6&height=220&section=header&text=NADIJA WELIHENA GAMAGE&fontSize=55&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Computer%20Science%20and%20Engineering (UG) %20%&descSize=16" width="100%"/>
...
<p>
<img src="https://skillicons.dev/icons?i=cpp,java,python,dart,js,ts&theme=dark"/>
</p>
...
<details>
<summary><strong>💻 Programming Problem Solving</strong></summary>
...
`C++` `Java` `Python` `Dart` `Flutter` `JavaScript` `TypeScript` `Git` `Linux` `Algorithms` `Data Structures`
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:312e81,50:6366f1,100:8b5cf6&height=120&section=footer" width="100%"/>
